package me.user.distributedsystems.eventdeliverysystem.client.producer;
...
import me.user.distributedsystems.eventdeliverysystem.client.consumer.domain.Connection;
import me.user.distributedsystems.eventdeliverysystem.common.message.Message;
import me.user.distributedsystems.eventdeliverysystem.client.Node;
import me.user.distributedsystems.eventdeliverysystem.common.message.UpdateMessage;

import java.io.IOException;
import java.security.NoSuchAlgorithmException;

import static me.user.distributedsystems.eventdeliverysystem.common.message.UpdateMessage.UpdateType.REGISTER;
import static me.user.distributedsystems.eventdeliverysystem.common.message.UpdateMessage.UpdateType.UNREGISTER;
