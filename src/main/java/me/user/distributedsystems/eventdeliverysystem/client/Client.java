package me.user.distributedsystems.eventdeliverysystem.client;

import me.user.distributedsystems.eventdeliverysystem.client.consumer.Consumer;
import me.user.distributedsystems.eventdeliverysystem.client.consumer.domain.Broker;
import me.user.distributedsystems.eventdeliverysystem.client.consumer.domain.Topic;
import me.user.distributedsystems.eventdeliverysystem.common.message.ImageMessage;
...
import me.user.distributedsystems.eventdeliverysystem.client.producer.Producer;
import me.user.distributedsystems.eventdeliverysystem.common.message.VideoMessage;
...
import static me.user.distributedsystems.eventdeliverysystem.client.MessageComposer.composeMessageFor;
